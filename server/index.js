...
const createCommentRouter = require("./routes/blog.routes");
const getCommentRouter = require("./routes/blog.routes");
const deleteCommentRouter = require("./routes/blog.routes");
